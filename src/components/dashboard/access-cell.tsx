  ...
  if (access?.state === "granted") {
    return (
      <div className="flex flex-col gap-1.5">
        <span className="inline-flex items-center gap-1.5 bg-green-50 text-green-700 px-2 py-1 rounded text-xs font-bold w-fit">
    ...
    return (
      <div className="flex flex-col gap-1">
        <button
          ...
          onClick={handleBuy}
          disabled={buying}
          className="inline-flex items-center bg-black text-[#FAF6EC] px-3 py-1.5 rounded text-xs font-bold hover:bg-black shadow-sm disabled:opacity-50 w-fit"
        >
