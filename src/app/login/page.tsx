      ...
      <div className="w-full max-w-md bg-[#FAF6EC] rounded-2xl shadow-sm border border-[#E5DCC8] p-8">
        ...
        <form className="space-y-5" action="/dashboard">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#" className="text-xs text-black underline hover:no-underline font-medium">
                Forgot?
              </a>
            </div>
            <input
          ...
          <button
            type="submit"
            className="w-full bg-black text-[#FAF6EC] font-bold p-3 rounded-lg hover:bg-black transition-colors shadow-sm"
          >
            Log in
          </button>
        </form>
        ...
        <div className="mt-6 relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-[#FAF6EC] text-gray-500">Or continue with</span>
          </div>
        </div>
