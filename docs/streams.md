...
**Next unreserved letter: `V`.** L–S are reserved by `docs/phase-6-roadmap.md`; T is reserved by follow-up #113; A–H are spent in the pre-Phase-6 namespaces (below) and are not reused for new work.
